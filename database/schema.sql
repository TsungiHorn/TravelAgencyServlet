...
ALTER TABLE "user_tours"
    ADD CONSTRAINT "user_tours_fk0" FOREIGN KEY ("user_id") REFERENCES "user" ("id");
ALTER TABLE "user_tours"
    ADD CONSTRAINT "user_tours_fk1" FOREIGN KEY ("tour_id") REFERENCES "tour" ("id");
ALTER TABLE "user_tours"
    ADD CONSTRAINT "user_tours_fk2" FOREIGN KEY ("status_id") REFERENCES "tour_status" ("id");